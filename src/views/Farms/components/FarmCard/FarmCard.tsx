...
const FarmCard: React.FC<FarmCardProps> = ({ farm, removed, cakePrice, account }) => {
  ...
  // We assume the token name is coin pair + lp e.g. POLEX-BNB LP, LINK-BNB LP,
  // NAR-POLEX LP. The images should be cake-bnb.svg, link-bnb.svg, nar-cake.svg
  ...
  const earnLabel = farm.dual ? farm.dual.earnLabel : 'POLEX'
  ...
  return (
    <FCard>
      {farm.token.symbol === 'POLEX' && <StyledCardAccent />}
      <CardHeading
        lpLabel={lpLabel}
