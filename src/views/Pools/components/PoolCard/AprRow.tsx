...
import { Flex, TooltipText, IconButton, useModal, CalculateIcon, Skeleton, useTooltip } from '@becoswap-libs/uikit'
...
const AprRow: React.FC<AprRowProps> = ({
  ...
  const tooltipContent = isAutoVault
    ? t('APY includes compounding, APR doesn’t. This pool’s POLEX is compounded automatically, so we show APY.')
